...
public static class AICodeConventionPackageMenu
{
    private const string MenuRoot = "Tools/Package/AI Code Convention/";
    private const string ReadmePath = "Packages/com.actionfit.ai-codeconvention/README.md";
